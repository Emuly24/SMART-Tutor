...
// Send reminders for 24h overdue (24-36h)
...
while ($r = $pending->fetch_assoc()) {
    ...
    $output .= "Reminder sent to {$r['fullname']}<br>";
}

// Suspend for 36h overdue
...
while ($r = $overdue->fetch_assoc()) {
    ...
    $output .= "Suspended {$r['fullname']}<br>";
}

if (empty($output)) $output = "No pending actions.";
?>
<!DOCTYPE html>
<html><head><title>Run Pending Exercise Checks</title><link rel="stylesheet" href="style.css"></head>
<body>
    <?php include_once 'includes/header.php'; ?>
    <div class="container">
        <div class="card">
            <h2>Pending Exercise Check Results</h2>
            <div><?= $output ?></div>
