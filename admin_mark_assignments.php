...
<div class="content-grid">
<?php while($s=$subs->fetch_assoc()):?><div><a href="admin_mark_assignments.php?assignment_id=<?=$aid?>&user_id=<?=$s['user_id']?>"><?=htmlspecialchars($s['fullname'])?></a> - Marks: <?=$s['marks']??'Not marked'?></div><?php endwhile;?><a href="admin_assignments_list.php">Back</a>
</div>
<div class="footer"><a href="admin_dashboard.php" class="btn-back">← Back</a></div>
</div>
...
<div class="content-grid">
<?php while($a=$assignments->fetch_assoc()):?><div><strong><?=htmlspecialchars($a['title'])?></strong> (Due <?=$a['due_date']?>) - Submissions: <?=$a['subcnt']?> <a href="admin_mark_assignments.php?assignment_id=<?=$a['id']?>">Mark</a></div><?php endwhile;?> 
</div>
<div class="footer"><a href="admin_dashboard.php" class="btn-back">← Back</a></div>
</div>
