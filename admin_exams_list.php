...
<h1>📝 Manage Exams</h1><a href="admin_create_exam.php">+ Create New Exam</a><table class="data-table" border="1"><tr><th>ID</th><th>Title</th><th>Subject</th><th>Class</th><th>Duration</th><th>Questions</th><th>Actions</th></tr><?php while($e=$exams->fetch_assoc()):?><tr><td><?=$e['id']?></td><td><?=htmlspecialchars($e['title'])?></td><td><?=$e['subject']?></td><td><?=$e['class_level']?></td><td><?=$e['duration_minutes']?></td><td><?=$e['qcnt']?></td><td><a href="admin_add_questions.php?exam_id=<?=$e['id']?>">Edit Q's</a> | <a href="admin_mark_exams.php?exam_id=<?=$e['id']?>">Mark</a> | <a href="?delete=<?=$e['id']?>" onclick="return confirm('Delete?')">Delete</a></td></tr><?php endwhile;?></table><a href="admin_dashboard.php">Back</a>
</div>
