...
<h1>📎 Export Covered Topics</h1><form action="admin_export_covered_topics.php" method="get"><label>Class:</label><select name="class"><option value="all">All</option><option value="Form 3">Form 3</option><option value="Form 4">Form 4</option></select><button type="submit">Download CSV</button></form> 
</div>
