 ...
 tinymce.PluginManager.add('mathquill', function (editor, url) {
     ...
     var panelButton = {
         ...
         panel: {
             ...
             html: "<div style=\"all:initial;\"><style type=\"text/css\">.mq-root-block * {vertical-align:middle;text-align:center;}</style><link rel=\"stylesheet\" href=\"https://cdnjs.cloudflare.com/ajax/libs/mathquill/0.10.1/mathquill.css\" /><span id=\"math-field\" style=\"position:absolute;left:5px;right:5px;top:5px;bottom:5px;\"></span></div>",
             onhide: function (e) {
