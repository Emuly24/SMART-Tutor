...
<div class="header"><h1>admin_mark_exams</h1><a href="admin_dashboard.php">Dashboard</a><a href="logout.php" class="logout">Logout</a></div>
<div class="content-grid">
<h1>Select Exam to Mark</h1><?php while($e=$exams->fetch_assoc()):?><div><strong><?=htmlspecialchars($e['title'])?></strong> (<?=$e['subject']?>) - <?php if($e['pending']>0) echo "<a href='admin_mark_exams.php?exam_id={$e['id']}'>View students ($e[pending] pending)</a>"; else echo "No submissions";?></div><?php endwhile;?><a href="admin_dashboard.php">Back</a>
</div>
<div class="footer">SMART Tutor – Admin Panel</div>
</div>
</body></html>